from stylegan_3d import StyleGAN
import argparse
...
def parse_args():
    ...
    parser.add_argument('--dataset_dir', type=str, help='The dataset name what you want to generate')
    parser.add_argument('--scratch_dir', type=str, help='Where to copy the data for fast io.')
    ...
    parser.add_argument('--img_size', type=int, default=512, help='The target size of image')
