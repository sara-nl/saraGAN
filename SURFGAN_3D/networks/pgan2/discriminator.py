...
def discriminator_block(x, filters_in, filters_out, activation, param=None):
    ...
    with tf.variable_scope('residual'):
        t = downscale3d(x)
        t = conv3d(t, filters_out, (1, 1, 1), activation, param=param)
...
def discriminator(x, alpha, phase, num_phases, base_shape, base_dim, latent_dim, activation, param=None, is_reuse=False, size='m', conditioning=None):
